<?php
// dashboard_user_manage.php - 后台用户管理页面（文件系统版本）
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        table { width: 100%; border-collapse: collapse; background-color: white; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); }
    ...
    <script>
        function manageUser(user, action) {
            ...
            let url = 'dashboard_user_action.php?admin=' + encodeURIComponent('<?php echo $admin; ?>') + '&user=' + encodeURIComponent(user) + '&action=' + action;
